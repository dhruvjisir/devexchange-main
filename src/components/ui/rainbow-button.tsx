  ...
  return (
    <button
      className={cn(
        ...
        // dark mode colors
        "dark:bg-[linear-gradient(#0f172a,#0f172a),linear-gradient(#0f172a_50%,rgba(15,23,42,0.8)_80%,rgba(15,23,42,0)),linear-gradient(90deg,hsl(var(--color-1)),hsl(var(--color-5)),hsl(var(--color-3)),hsl(var(--color-4)),hsl(var(--color-2)))] dark:text-white dark:shadow-[0_0_15px_rgba(255,255,255,0.1)]",
